...
<div class="lc-course-note">
  <strong>使用说明：</strong>① 全部课时合计约 5 小时 10 分，建议全天完训，亦可按模块拆分为五次午间分享；② 各课「配套资料」均为本站在线页面，培训后可直接对照演练；③ 诉讼类课程涉及法条与期限规则的，一律以现行有效法律法规为准并经主办律师复核，AI 输出不得直接进入对外文书；④ 课程内容持续迭代，最新版本以本页为准。
</div>
