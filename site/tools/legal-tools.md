...
<div class="lc-course-hero">
  ...
  <div class="lc-course-stats">
    ...
    <div class="lc-course-stat"><b>311</b><span>分钟 · 一天完训</span></div>
...
<div class="lc-course-module">
  <div class="lc-course-module-head"><span class="lc-course-part">PART 1</span><h3>基础与方法</h3><span class="lc-course-module-meta">4 门 · 约 49 分钟</span></div>
  <ul class="lc-course-list">

  <li class="lc-course-item">
    <div class="lc-course-row"><span class="lc-course-no">01</span><p class="lc-course-name">AI 工具矩阵与法律 Skills 体系</p><span class="lc-course-time">10 分钟</span></div>
  ...
  <li class="lc-course-item">
    <div class="lc-course-row"><span class="lc-course-no">02</span><p class="lc-course-name">项目配置、指令文件与记忆体系</p><span class="lc-course-time">14 分钟</span></div>
    <ul class="lc-course-points">
      <li>全局指令与项目指令两级分工：立场红线放全局、项目口径放项目，指令要具体到可验证</li>
      <li>智能体记忆机制：哪一层该硬（指令）、哪一层该软（自动记忆），定期审计与脱敏纪律</li>
      <li>训练将团队经验沉淀为可复用的项目指令包和法律业务操作规范</li>
    </ul>
  ...
  <li class="lc-course-item">
    <div class="lc-course-row"><span class="lc-course-no">03</span><p class="lc-course-name">MCP 数据源接入与资料安全</p><span class="lc-course-time">10 分钟</span></div>
    <ul class="lc-course-points">
      <li>北大法宝、元典、企查查、见微、腾讯 ima 五大数据源的接入形态、计费方式与调用边界</li>
      <li>双 Key 轮换、装前探活装后实测、Token 权限收紧与每月安全盘点</li>
      <li>客户资料上传边界、敏感信息脱敏与自动化任务安全要求</li>
    </ul>
  ...
  <li class="lc-course-item">
    <div class="lc-course-row"><span class="lc-course-no">04</span><p class="lc-course-name">AI 定时任务与关键期限预警</p><span class="lc-course-badge-new">新增</span><span class="lc-course-time">15 分钟</span></div>
    <ul class="lc-course-points">
...
<div class="lc-course-module">
  <div class="lc-course-module-head"><span class="lc-course-part">PART 2</span><h3>合同与商业核查</h3><span class="lc-course-module-meta">3 门 · 约 62 分钟</span></div>
  <ul class="lc-course-list">

  <li class="lc-course-item">
    <div class="lc-course-row"><span class="lc-course-no">05</span><p class="lc-course-name">合同审查、起草修订与 OA 流程自动审查</p><span class="lc-course-time">36 分钟</span></div>
    <ul class="lc-course-points">
      <li>按投资、采购、租赁、服务、保密等商业场景建立审查清单和专用 Skills</li>
      <li>条款抽取、风险分级、缺失条款提示、对方立场识别与针对性审查意见生成</li>
      <li>合同框架、条款初稿、修订建议、谈判要点和审查意见表的成稿路径</li>
      <li>OA 合同流转到法务节点的自动审查流程：文件读取 → 规则调用 → 报告生成 → 人工确认 → 结果回填</li>
    </ul>
  ...
  <li class="lc-course-item">
    <div class="lc-course-row"><span class="lc-course-no">06</span><p class="lc-course-name">网络核查（合规）与证据留痕</p><span class="lc-course-time">14 分钟</span></div>
    <ul class="lc-course-points">
      <li>主体资质、行政处罚、失信被执行、涉诉信息、域名/官网、舆情信息的网核清单搭建</li>
      <li>自动检索、网页保存、截图/链接留痕、证据目录、核查底稿文件夹与结论表整理</li>
    </ul>
  ...
  <li class="lc-course-item">
    <div class="lc-course-row"><span class="lc-course-no">07</span><p class="lc-course-name">知识产权核查与全球商标台账</p><span class="lc-course-time">12 分钟</span></div>
    <ul class="lc-course-points">
      <li>商标台账字段：国家/地区、申请号、注册号、类别、权利人、状态、期限与续展节点</li>
      <li>公开数据库、代理机构报告与内部台账的定期更新与异常提醒</li>
    </ul>
...
<div class="lc-course-module">
  ...
  <li class="lc-course-item">
    ...
    <ul class="lc-course-points">
      ...
      <li>权威案例优先援引：指导性案例、公报案例、典型案例的检索次序</li>
    </ul>
  ...
  <li class="lc-course-item">
    ...
    <ul class="lc-course-points">
      ...
      <li>调查表批量更新：董监高、核心技术人员、机构股东、间接自然人股东的北交所口径转换</li>
    </ul>
  ...
  <li class="lc-course-item">
    ...
    <ul class="lc-course-points">
      ...
      <li>出资流水：前后六个月逐笔核查口径（5 万元阈值/附言关键词/同名股东）、承诺函逐笔表格改版</li>
    </ul>
  ...
  <li class="lc-course-item">
    ...
    <ul class="lc-course-points">
      ...
      <li>查验计划与章程制度体系的新三板转北交所口径深度改造</li>
    </ul>
...
<div class="lc-course-module">
  ...
  <li class="lc-course-item">
    ...
    <ul class="lc-course-points">
      ...
      <li>统一归档网核底稿、审查记录、检索报告、台账与交付材料</li>
    </ul>
...
<div class="lc-course-note">
  <strong>使用说明：</strong>① 全部课时合计约 5 小时 10 分，建议全天完训，亦可按模块拆分为五次午间分享；② 各课「配套资料」均为本站在线页面，培训后可直接对照演练；③ 诉讼类课程涉及法条与期限规则的，一律以现行有效法律法规为准并经主办律师复核，AI 输出不得直接进入对外文书；④ 课程内容持续迭代，最新版本以本页为准。另：本页法律工具清单持续建设中，将按实际使用频率与稳定性逐步补充收录。
</div>
