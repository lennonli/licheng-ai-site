...
<div class="lc-course-module">
  ...
  <ul class="lc-course-list">
    ...
    <ul class="lc-course-points">
      ...
      <li>反编造纪律：引用任何法律条文号、规则名称、案号必须回官方来源逐字核对，核验不了的标注【待核验】；期限速查表（上诉期、举证期限、审限等）统一口径并建提醒任务盯守</li>
  ...
  <li class="lc-course-item">
    ...
    <ul class="lc-course-points">
      ...
      <li>对方主体画像与偿付能力调查：涉诉与被执行记录、股权冻结出质、破产线索——保全紧迫性建议（高/中/低＋理由）</li>
  ...
  <li class="lc-course-item">
    ...
    <ul class="lc-course-points">
      ...
      <li>证明目的倒推编组：以事实主张为纲反向编排证据组——无证据支撑的主张列入待补清单并给出取证路径（调查令/申请调取/公证）；依据《民事诉讼证据规定》核对称当事人举证要求</li>
  ...
  <li class="lc-course-item">
    ...
    <ul class="lc-course-points">
      ...
      <li>程序核验：管辖条款效力、仲裁条款逐份排查、诉讼时效、共同被告追加；补入文书记明事项依据（《民事诉讼法》第 121 条等经核验条文）</li>
  ...
  <li class="lc-course-item">
    ...
    <ul class="lc-course-points">
      ...
      <li>六类当庭情形应对话术：突袭证据、当庭认可、法官追问、金额争议、对方情绪化表态、申请休庭核对的时机判断</li>
  ...
  <li class="lc-course-item">
    ...
    <ul class="lc-course-points">
      ...
      <li>法官角色归纳争议焦点、双向询问问题与释明预警——对照修正庭审提纲</li>
  ...
  <li class="lc-course-item">
    ...
    <ul class="lc-course-points">
      ...
      <li>庭后补充回应：对方突袭观点与新证据的针对性拆解；模拟演练暴露弱点的书面补强</li>
  ...
  <li class="lc-course-item">
    ...
    <ul class="lc-course-points">
      ...
      <li>隐含信号识别：法院未回应的诉请/抗辩——程序或说理瑕疵线索</li>
  ...
  <li class="lc-course-item">
    ...
    <ul class="lc-course-points">
      ...
      <li>追加被执行人的法定情形逐项对照与类案支撑（案号回库核验）</li>
...
<div class="lc-course-note">
  <strong>使用说明：</strong>① 全部课程可一天完训或按模块多次安排，节奏弹性掌握；② 各课「配套资料」均为本站在线页面，培训后可直接对照演练；③ 诉讼类课程涉及法条与期限规则的，一律以现行有效法律法规为准并经主办律师复核，AI 输出不得直接进入对外文书；④ 课程内容持续迭代，最新版本以本页为准。另：本页法律工具清单持续建设中，将按实际使用频率与稳定性逐步补充收录。
</div>
