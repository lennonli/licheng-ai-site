...
const articleFiles = htmlFiles.filter((file) => /\/(agents|skills|tutorials|kb|kb2025|kb2024|kb2023|ma2026|ma2025|ma2024|ma2023|refi2025|refi2024)\/.+\.html$/.test(file) && !/\/index\.html$/.test(file))
